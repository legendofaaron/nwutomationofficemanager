    ...
    <SidebarProvider defaultOpen={sidebarOpen}>
      <div className="min-h-screen bg-app-gray-lightest flex w-full">
        <div className="relative">
          ...
          <SidebarTrigger className="absolute -right-12 top-8 z-20 h-16 w-12 bg-white shadow-md rounded-r-lg flex items-center justify-center hover:bg-gray-50 transition-colors">
