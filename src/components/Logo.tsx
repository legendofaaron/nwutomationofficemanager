...
export const Logo = ({
  ...
  return <div className="flex items-center gap-2 hover:opacity-90 transition-opacity cursor-pointer" onClick={onClick}>
      {branding.logoType === 'image' && branding.logoUrl ? <img src={branding.logoUrl} alt={`${branding.companyName} logo`} className={`h-${small ? '4' : '6'} w-auto`} /> : <div className="relative">
