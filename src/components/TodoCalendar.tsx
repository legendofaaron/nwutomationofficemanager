...
const TodoCalendar = () => {
    ...
    return (
      <div className="relative w-full h-full flex items-center justify-center">
        <div className={cn("flex flex-col items-center justify-center", isSelected && "font-bold")}>
          {dateValue}
          {taskCount > 0 && (
            <Badge variant="secondary" className="absolute -bottom-1 px-1 py-0 min-w-5 h-4 text-[0.65rem] flex items-center justify-center">
              {taskCount}
            </Badge>
          )}
        </div>
  ...
  return (
    <>
              ...
              <CardContent className="p-3">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <div className="space-y-1 max-h-36 overflow-y-auto py-1">
                    {todaysTodos.length > 0 ? todaysTodos.map(todo => (
                      <div 
                        key={todo.id} 
      ...
      <TaskBubble 
        tasks={todos}
        onToggleTask={toggleTodoCompletion}
